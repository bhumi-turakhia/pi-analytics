  ...
  const stats = [
    {
      ...
      value: `${sourceCount}`,
      subtext: sourceCount === 1 ? 'Connected source' : 'Connected sources',
    ...
    },
    {
      ...
      value: `${tableCount}`,
      subtext: 'Indexed catalog entities',
    ...
    },
    {
      ...
      subtext: 'Latest catalog synchronization',
    ...
    },
    {
      ...
      value: `${cacheHitRatio}%`,
      subtext: 'Query & metadata cache ratio',
      status: cacheHitRatio > 0 ? 'Active' : 'No cache data',
